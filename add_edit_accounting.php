                ...
                <div id="ess_right_card" class="row ess_card ess_padding_top">
                    ...
                    <div class="col-xs-12 ess_no_padding">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" data-rule-required="true" class="form-control "
                                                   ...
                                                   value="<?= isset($_DATA) ? $_DATA['trav_amount'] : "0"; ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" data-rule-required="true" class="form-control date-timepicker"
                                                   ...
                                                   value="<?= isset($_DATA) ? $_DATA['trav_date_of_departure'] : ""; ?>" <?= isset($_DATA) ? "readonly" : ""; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" data-rule-required="true" class="form-control date-timepicker"
                                                   ...
                                                   value="<?= isset($_DATA) ? $_DATA['trav_date_of_arrival'] : ""; ?>" <?= isset($_DATA) ? "readonly" : ""; ?>>
                                            <span class="input-group-addon" style="border-radius: 0 10px 10px 0 !important;">
												<i class="fa fa-clock-o bigger-110"></i>
											</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" data-rule-required="true" class="form-control date-timepicker"
                                                   ...
                                                   value="<?= isset($_DATA) ? $_DATA['trav_date_of_return'] : ""; ?>" <?= isset($_DATA) ? "readonly" : ""; ?>>
                                            <span class="input-group-addon" style="border-radius: 0 10px 10px 0 !important;">
												<i class="fa fa-clock-o bigger-110"></i>
											</span>
                                        </div>
                        				...
                        				<form id="form-accomodation" class="form-horizontal" novalidate="novalidate">
                                            <fieldset>
                                                <div class="col-md-6 ess_ae">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="selectbasic" class="control-label">Unit Amount</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="text" class="form-control "
                                                                   ...
                                                                   value="<?= isset($_DATA) ? $_DATA['trav_per_diem_purpose'] : ""; ?>">
                                                        </div>
                                                    </div>
                        ...
                        <div class="wizard-actions">
                            ...
                            <?php if($_DATA['trav_main_status'] == 'Approved') { ?>
...
<!--
<div class="row-fluid" style="<?php //echo (isset($_EDIT) && $_EDIT == 1) ? "" : "display:none;"; ?>">
    <div class="col-xs-12 ess_padding_lr">
        
        <div class="row">
            
            <div class="col-xs-12 zoomIn animated dashboard_tab ess_pt_lines">
                
                <div class="row ess_card">
                    <h4 class="ess_title">Lines&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Net Amount: <span id="tna">0</span></h4>
                    <div class="col-xs-12 ess_no_padding">
                        <table id="ess_travel_requisition_lines" class="display ess_table" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>Date</th>
                                <th>Travel Type</th>
                                ...
                                <th>No of days</th>
                                <th>Daily rate amount</th>
                                <th>Amount</th>
                                <th>Advance Holder</th>
                                <th>Purpose</th>
                                <th></th>
                            </tr>
                            </thead>
    ...
    $(document).ready(function () {
        ...
        $('#trav_date_of_return').on('dp.change', function(e){ 
            ...
            if(arrivaldate != ""){
                ...
                var diffInDays = parseInt(diffInMs / (1000 * 60 * 60 * 24));
